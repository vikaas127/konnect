...
reportcreditInvoice(context, InvoiceModal model, CompanyModal company,LedgerModal ledgerdata) async {
    ...
    pdf.addPage(MultiPage(
      ...
      build:
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  getRowDesign('Debite Note No.', 12),
                  getRowDesign(ledgerdata.name, 10),
                  getRowDesign('Supplier Ref.', 12),
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  getRowDesign('Dated ', 12),
                  getRowDesign(ledgerdata.name, 10),
                  getRowDesign('Other Refernces.', 12),
        ...
        Table.fromTextArray(context: context,cellAlignment: Alignment.center,cellStyle:TextStyle(color: PdfColors.black ,
            ...
            data: <List<String>>[
              <String>['S.No','ITEM', 'UNIT','RATE','QTY','TOTAL'],
...
getRowDesign(String ? text, double fontSize) {
  return Padding(
    ...
    child: Text(
      text!,
      style: TextStyle(font:Font.courier(),
          fontSize: fontSize,
