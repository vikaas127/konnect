...
reportSalesInvoice(context, InvoiceModal model, CompanyModal company,LedgerModal ledgerdata) async {
    ...
    pdf.addPage(MultiPage(
      ...
      build:
        ...
        Table.fromTextArray(context: context,cellAlignment: Alignment.center,cellStyle:TextStyle(color: PdfColors.black ,
            ...
            headerDecoration: new BoxDecoration(color:  PdfColor.fromInt(0xff374ABE),),tableWidth:
