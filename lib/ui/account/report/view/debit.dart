...
class DebitViewPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
   return DebitViewPage_state();
  }
}



class DebitViewPage_state extends State<DebitViewPage> {
      ...
      appBar: AppBar(
        actions: [
          IconButton(icon: Icon(Icons.picture_as_pdf),
              onPressed: ()
              {reportdebitInvoice(context, widget._modal,company,_ledger!);}
          )],
        leading: IconButton(
