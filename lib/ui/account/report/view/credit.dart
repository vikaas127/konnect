...
import 'package:konnect/ui/account/pdfview/CreditInvoicerpdf.dart';
import 'package:konnect/ui/account/pdfview/DebitInvoicerpdf.dart';
...
class CreditViewPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return CreditViewPage_state();
  }
}
class CreditViewPage_state extends State<CreditViewPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Debit Note View')),
      body: ListView(
      ...
      appBar: AppBar(
        actions: [
          IconButton(icon: Icon(Icons.picture_as_pdf),
              onPressed: ()
              {reportcreditInvoice(context, widget._modal,company,_ledger!);}
          )],
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios, color: Colors.white),
          onPressed: () => Navigator.of(context).pop(),
        ),
        title: Text('Credit Note',style: theme().title16w,),
      ),
      body: ListView(
        padding: EdgeInsets.all(18),
        children: [
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: Stack(
                                  children: <Widget>[
                                    Center(
                                      child: getRowDesign('Debit Note', 15),
                                    ),
                                  ...
                                  Container(child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        getRowDesign('Debit Note No :- ${widget._modal.voucherNumber}', 15),
                                        getRowDesign('Supplier Ref :- ${widget._modal.vchKey}', 15),
                                      ],
                                    ),
                                  ),
                                  ...
                                  Container(child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        getRowDesign('Dated :- ${widget._modal.voucherDate}', 15),
                                        Divider(),
                                        getRowDesign('Other Refernces :- ${_ledger!.incometexnumber!}', 15),
                                      ],
                                    ),
                                  ),
                              ...
                              DataTable(
                                columns: [
                                  DataColumn(label: Text('Description of Gods',style: theme().title16b)),
                                  //  DataColumn(label: Text('Description of Gods',style: theme().title16b,)),
          ...
          Text('Amount Chargeable(in words)',style: theme().title18p,),
          Text('${widget._modal.productTotalAmount}'),
...
/*class CreditViewPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var _name = _modal.partyLedgerName;
    return Scaffold(
      appBar: AppBar(title: Text('Credit Note View')),
      body: ListView(
        padding: EdgeInsets.all(18),
        children: [
          FutureBuilder<LedgerModal?>(
