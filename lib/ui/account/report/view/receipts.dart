...
import 'package:konnect/ui/account/pdfview/ReciptInvoice.dart';
import 'package:konnect/ui/account/pdfview/SalesInvoicerpdf.dart';

class ReceiptsViewPage extends StatefulWidget {
  final InvoiceModal _modal;
  ...
  State<StatefulWidget> createState() {
    return ReceiptsViewPage_state();
  }
}
class ReceiptsViewPage_state extends State<ReceiptsViewPage> {
      ...
      appBar: AppBar(
        actions: [
          IconButton(icon: Icon(Icons.picture_as_pdf),
              onPressed: ()
              {reportReciptInvoice(context, widget._modal,company,_ledger!);}
          )],
        leading: IconButton(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                            ...
                            children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        getRowDesign('Date :- $dateFormat(${widget._modal.voucherDate})', 15),
                                      ],
                                    ),
                                  ),
                                  Container(
                              ...
                              DataTable(
                                columns: [
                                  DataColumn(label: Text('Amount(words)',style: theme().title16b)),
                                  //   DataColumn(label: Text('HSN',style: theme().title16b,)),
                                  DataColumn(label: Text('Amount',style: theme().title16b,)),
                                  DataColumn(label: Text('PaymentMode',style: theme().title16b,)),
                                  DataColumn(label: Text('Receipt Type',style: theme().title16b,)),
                                  //DataColumn(label: Text('AMT')),
                                  DataColumn(label: Text('Receipt By',style: theme().title16b,)),
